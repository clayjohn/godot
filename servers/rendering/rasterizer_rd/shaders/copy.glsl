...
void main() {
	...
	local_cache[write_index] = color_top;
	local_cache[write_index + 1] = color_bottom;
	...
	color += local_cache[index] * 0.174938;
	color += local_cache[index + 1] * 0.165569;
	color += local_cache[index + 2] * 0.140367;
	color += local_cache[index + 3] * 0.106595;
	color += local_cache[index - 1] * 0.165569;
	color += local_cache[index - 2] * 0.140367;
	color += local_cache[index - 3] * 0.106595;
