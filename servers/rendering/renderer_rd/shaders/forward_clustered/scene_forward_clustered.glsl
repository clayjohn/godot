...
#define BIAS_FUNC(m_var, m_idx)                                                                 \
	...
	m_var.xyz += normal_bias;
				...
				if (sc_use_directional_soft_shadows && directional_lights.data[i].softshadow_angle > 0) {
					...
					shadow = sample_directional_pcf_shadow(directional_shadow_atlas, scene_data.directional_shadow_pixel_size * directional_lights.data[i].soft_shadow_scale * blur_factor, pssm_coord, scene_data.jitter_fraction);
					...
					if (directional_lights.data[i].blend_splits) {
						...
						float shadow2 = sample_directional_pcf_shadow(directional_shadow_atlas, scene_data.directional_shadow_pixel_size * directional_lights.data[i].soft_shadow_scale * blur_factor2, pssm_coord, scene_data.jitter_fraction);
